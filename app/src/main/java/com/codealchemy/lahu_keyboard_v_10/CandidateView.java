...
public class CandidateView extends View {
	...
	private LahuKeyboardIME mService;
	...
	public CandidateView(Context context) {
		...
		this.mSelectionHighlight = context.getResources().getDrawable(R.drawable.ic_keyboard_return_white_24dp);
	...
	public void setService(LahuKeyboardIME softKeyboard) {
